...
# Ebuild originally from moulay, with backported treesitter 0.20.2.
...
PATCHES=( "${FILESDIR}/helix-0.5.0-helix-core_src_lib.patch" "${FILESDIR}/helix-0.6.0-bump_treesitter.patch" )
