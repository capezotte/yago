...
# Incoporates changes by Perfect_Gentleman @ Gitlab (pg_overlay)
...
src_prepare() {
	...
	# I hate the GNU/Antichrist
	if use elibc_musl; then
		eapply "${FILESDIR}/alpine"
		# musl langinfo has lots of missing _NL fields
		sed -i '/ac_header/s/langinfo.h//' configure || die
	fi
